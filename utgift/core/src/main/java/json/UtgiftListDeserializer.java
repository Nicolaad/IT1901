...
public class UtgiftListDeserializer extends JsonDeserializer<UtgiftList> {
   ...
   @Override
    public UtgiftList deserialize(final JsonParser jsonParser, final DeserializationContext deserializationContext) throws IOException, JsonProcessingException {
